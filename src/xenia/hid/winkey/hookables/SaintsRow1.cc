...
struct GameBuildAddrs {
  ...
  uint32_t mp_flag_1;
  uint32_t mp_flag_2;
  uint32_t console_open_bool_addr;
};
...
std::map<SaintsRow1Game::GameBuild, GameBuildAddrs> supported_builds{
    ...
    {SaintsRow1Game::GameBuild::SaintsRow1_TU1,
     {"0.0.1.1",  0x827f9af8, 0x827F9B00, 0x827F9BA4, 0x82F7EB04, 0x835F2B80,
      ...
      0x835F1A58, 0x837DD080, 0x827F95B4, 0x835F33DF, 0x835F3522, 0x835F4C3E}},
    {SaintsRow1Game::GameBuild::SaintsRow1_JP,
     {"0.0.0.1",  0x827E9BF8, 0x827E9C00, 0x827E9CA4, 0x82F6E69C, 0x835E2718,
      ...
      0x835E15F0, 0x837CCC10, 0x827E96B4, 0x835E2F6E, 0x835E2F6F, 0x835E47BF}}};
  ...
  if (!mousehook_passthru_override &&
      *kernel_memory()->TranslateVirtual<uint8_t*>(
          supported_builds[game_build_]
              .console_open_bool_addr)) {  // byte that controls console status
